            ...
            for j in range(MAX_EPOCH):
                ...
                for i in range(NUMBER_OF_PARTICIPANTS):
                    ...
                    if i == 0:
                        ...
                        honest_node_side,correct_set = participants[i].detect_node_side(all_member_samples,last_batch)
                    else:
                        honest_node_side, correct_set = participants[i].nomarl_detection(i)
                    print(correct_set)
                    # print(honest_node_side)
                    # exec("correct_set%s = correct_set" % i)
                    exec("honest_node_side_list%s.append(honest_node_side)" % i)
                    ...
                    if j == 10:
                        ...
                        print(eval("correct_set%s " % i))
                    if 14>j>10:
                        monitor_list = participants[i].detect_attack(i)
                        print(monitor_list)
                        # print(eval("correct_set%s " % i))
                        if monitor_list != []:
